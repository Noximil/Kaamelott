...
async function fetchQuotes() {
  try {
    const response = await fetch("https://script.google.com/macros/s/AKfycbyWk0LW0E9vqJhtgWF2zr2Bb5rRsYCS5B4-EY-LrMM6k5_hhxr0PORG2j6camUge_WEQQ/exec");
...
document.getElementById("quote-form").addEventListener("submit", async function (e) {
  ...
  try {
    const res = await fetch("https://script.google.com/macros/s/AKfycbyWk0LW0E9vqJhtgWF2zr2Bb5rRsYCS5B4-EY-LrMM6k5_hhxr0PORG2j6camUge_WEQQ/exec", {
      method: "POST",
